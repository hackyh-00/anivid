...
let usernames = ['@senjuheart', '@joe__anime', '@baldshine', '@trunksvisuals', '@waifuss_loverr', '@.flourvx', '@.tez'];


function getRandomUsername() {
  if (usernames.length === 0) {
    usernames = ['@senjuheart', '@joe__anime', '@baldshine', '@trunksvisuals', '@waifuss_loverr', '@.flourvx', '@.tez'];
  }
